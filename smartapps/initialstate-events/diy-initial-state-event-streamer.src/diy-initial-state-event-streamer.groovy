...
def installed() {
	...
	atomicState.bucketKey = "JEHUY9AR7S4Y" //change if needed
	atomicState.bucketName = "South Cove DIY" //change if wanted
	atomicState.accessKey = "YALUEAYkUHradJKcqnPFekYoNR3C7gd6" //MUST CHANGE
