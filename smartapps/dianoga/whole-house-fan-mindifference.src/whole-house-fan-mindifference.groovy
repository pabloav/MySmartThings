 ...
 */
definition(
    name: "Whole House Fan MinDifference",
    namespace: "dianoga",
    author: "Brian Steere",
...
preferences {
    ...
    section("Temperature difference") {
        input "minDifference", "number", title: "Minimum Temperature Difference"
    }
...
def checkThings(evt) {
    ...
    if(insideTemp - outsideTemp < settings.minDifference) {
    	log.debug "Not running due to insideTemp - outsideTem < minDifference"
    	shouldRun = false;
    }
